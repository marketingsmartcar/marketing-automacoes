...
>
> Contas encerradas (lojas fechadas): BR PNEUS IBITINGA (`585036840552616`) e BR PNEUS JAÚ (`949063329571714`).
...
> Conta encerrada (loja fechada): BR PNEUS JAÚ (`123-944-1933`).
